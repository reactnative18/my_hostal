...
const HostelFloorManagment = ({ navigation }) => {
    const data = [
        { icon: CustomImage.logo, name: 'Ground Floor', rooms: '4' },
        { icon: CustomImage.logo, name: 'First Floor', rooms: '4' },
        { icon: CustomImage.logo, name: 'Second Floor', rooms: '4' },
        { icon: CustomImage.logo, name: 'Third Floor', rooms: '4' },
    ...
    const renderItem = ({ item, index }) => {
        return <Pressable style={styles.hostelContainer} onPress={() => navigation.navigate('HostelRoomManagment')}>
            ...
            <View style={styles.hostelContainer2}>
                ...
                <Text numberOfLines={2} style={styles.hostelAddress}>Totel {item.rooms} Rooms</Text>
            </View>
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headerView}>
                <BackButton navigation={navigation} text={"Ap boys Floors"} />
                <Pressable style={styles.buttonView} onPress={() => navigation.navigate('AddFloor')}>
