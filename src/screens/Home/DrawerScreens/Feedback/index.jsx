...
const Feedback = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Spacer height={10} />
            <BackButton navigation={navigation} text={'Feedback & Suggestions'} />
            <ScrollView showsVerticalScrollIndicator={false}>
                <Spacer height={25} />
                <Image source={CustomImage.feedback2} style={styles.image} />
                <Spacer height={25} />

                <Text style={styles.headingText}>Your Valuable Feedback & Suggestions</Text>
                <Spacer height={25} />
